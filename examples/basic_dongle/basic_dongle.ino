...
uint64_t program_id = 0; // program id must match between host and dongle
...
NRFDongle<float, 2> dongle(radio, 0, program_id, ping_interval_millis, pair_timeout_millis, data_rate, power_level, retry_delay, retry_count);
